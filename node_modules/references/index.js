    ...
    for (var i=0; i<path.length; i++) {
        if (path[i].type == 'call') {
            ...
            for (var j=0; j<path[i].arguments.length; j++) {
                var name = 'args.a' + j;
                args['a' + j] = instance_from_serializable(path[i].arguments[j]);
    ...
    for (var i=0; i<path.length; i++) {
        ...
        if (ref.type == "call") {
            ...
            for (var j=0; j<ref.arguments.length; j++) {
                source_args.push(get_source_version(instance_from_serializable(ref.arguments[j])));
            }
...
function create(name) {
    ...
    function call() {
        ...
        var execution_proxy = get(null, "*", null);
        execution_arguments.set(execution_proxy, arguments);
