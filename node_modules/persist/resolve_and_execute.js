    ...
    if (type == 'hashmap') {
        ...
        try {
            ...
            try {
                ...
                fn = scoped("function () {return (" + trimmed + ")}", value);
            }
            catch (error) {
                fn = scoped("function () {" + operation.script + "}", value);
            }
            returned = fn.apply(value);
            //  TODO if returned is a promise, wait for the promise before calling back!!!!
