            ...
            if (name == 'fulfill') {
                return function () {
                    ...
                    if (meta.get(proxy).loaded) {
                        ...
                        for (var i=0; i<fulfill_functions.length; i++) {
                            if (fulfill_functions[i]) {
                                references.resolve(
                                    references.apply(
                                        fulfill_functions[i],
                                        arguments
                ...
                return function () {
                    ...
                    if (meta.get(proxy).loaded) {
                        ...
                        for (var i=0; i<reject_functions.length; i++) {
                ...
                return function (on_fulfill, on_reject) {
                    ...
                    if (get_type(on_fulfill) == 'reference') fulfill_ref = on_fulfill;
                        ...
                        var ref_to_val
                        try {
                            ref_ro_val = reference_to_value(on_fulfill);
                        }
                        catch (err) {
                    ...
                    if (get_type(on_fulfill) == 'reference') reject_ref = on_reject;
                        ...
                        var ref_to_val
                        try {
                            ref_ro_val = reference_to_value(on_reject);
                        }
                        catch (err) {
                    ...
                    fulfill_functions.push(fulfill_ref);
                    reject_functions.push(reject_ref);
