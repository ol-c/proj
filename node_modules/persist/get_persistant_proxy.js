...
function get_persistant_proxy(type, id) {
    ...
    function list_reverse() {
        ...
        //  TODO: send extra update data notifying that this was a reverse
        var self_reference = [{name : id, type : 'reference'}];
        send_to_watching(null, self_reference, proxy);
    ...
    function list_sort(fn) {
        ...
        //  TODO: send extra update data notifying that this was a sort
        var self_reference = [{name : id, type : 'reference'}];
        send_to_watching(null, self_reference, proxy);
    ...
    function list_splice() {
        ...
        //  TODO: send extra update data notifying that this was a splice
        var self_reference = [{name : id, type : 'reference'}];
        send_to_watching(null, self_reference, proxy);
    ...
    function list_unshift() {
        ...
        //  TODO: send extra update data notifying that this was an unshift
        var self_reference = [{name : id, type : 'reference'}];
        send_to_watching(null, self_reference, proxy);
