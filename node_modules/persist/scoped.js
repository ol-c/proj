...
function scoped(expression, object, agent) {
    ...
    custom_env.root = environment.reference[persist.get_root()]
    custom_env.remote = environment.reference;
    custom_env.self = environment.reference[persist.identify(object)];
    delete custom_env.reference;
