    ...
    return function (data) {
        ...
        try {
            ...
            if (external_requester) {
                ...
                reference.requesters = [external_requester];
            }
            serializable(reference, function (error, response) {
                if (error) send(error_report(error, true, reference));
...
function handleWS(connection) {
    //  TODO: add requesting user to reference
