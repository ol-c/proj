...
function process_operation(context, operation, send, external_requester) {
    try {
        ...
        else if (operation.type == "success" || operation.type == "error") {
            //  success responses do not need to go back to originator
            //  if no response set for this operation, ignore this
            //  success result
        }
        else {
